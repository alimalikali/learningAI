"""
Centralized config for LangChain RAG.

Same pattern as Project 2 — but notice how much less config we need now.
LangChain handles batching, retries, rate limits internally.
"""
...
class Config:
    """
    Immutable configuration for the LangChain RAG system.
...
def load_config() -> Config:
    ...
    collection_name = os.getenv("COLLECTION_NAME", "langchain_rag")
